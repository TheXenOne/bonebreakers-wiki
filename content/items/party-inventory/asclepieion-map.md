...
- In [[sessions/session-012|Session 12]], the map falls out of the encoded tome while the party researches the sanctum's clues.

## Current status

The map serves as a party clue object. Later handling details are not clearly documented. Needs review.
