...
- [[npcs/barrowshire/barrow-spa-locals/aldrich|Aldrich]] identifies the dagger after the shrine expedition.
- The dagger lets its user see through a creature's eyes while the blade remains lodged in that creature.
- The Session 8 identification describes the effect as working when the victim is stabbed in the back. Exact limits and whether the angle matters in later use: Needs review.

## Known history

- In [[sessions/session-007|Session 7]], the party recovers the red dagger from shrine treasure.
- In [[sessions/session-008|Session 8]], Barny uses it on a fleeing rat to glimpse [[npcs/barrowshire/tarantella-manor/rat-queen|the Rat Queen]] deeper inside the Jeweller's Sanctum.
