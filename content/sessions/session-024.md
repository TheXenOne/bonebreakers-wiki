...
- The priests are assigned to repairs, spying, research, and clerical duties.
- A force of twenty-one ninja-like orcs raids the church at night.
- Frank raises the alarm and helps repel the first wave.
- Krazak the Silent attacks Athlestan during the raid.
...
- The reclaimed cathedral grounds
- The church at night
...
- Barny's crystal ball confirms the hostages are still alive.
- A ransom note from Gruumsh sets the terms for the exchange.
- Magical charm is used to extract information from one of the raiders.
- The church's new internal structure is established before the raid interrupts it.
...
- Previous: [[sessions/session-023|Session 23 - Secrets in the Stone]]
- Next: [[sessions/session-025|Session 25 - A Deal with Gruumsh (And Other Bad Ideas)]]
