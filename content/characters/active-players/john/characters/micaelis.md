...
status: active
aliases:
  - characters/john/characters/micaelis
  - characters/micaelis
source_sessions:
  - 46
  - 47
...
- Formally joins the party near the Spider Market in [[sessions/session-046|Session 46]]. Later that night, he helps subdue a halfling assassin wearing Tobold's face by striking him hard across the head.
- In [[sessions/session-047|Session 47]], he commissions a spear for 500 gold pieces, continuing his effort to prove the weapon's superiority.
- In [[sessions/session-050|Session 50]], he claims one of three ancient imperial armour suits recovered from the undead in Ikiria's Plats. Ulrich identifies the armour as evil-aligned; Selvar later discovers that his own suit worsens his protection, but whether Micaelis's suit shares the curse remains unresolved. Micaelis also dismisses a beggar's report about a stolen boat before [[characters/active-players/ben-l/characters/arden-sable|Arden]] gives her money and thanks her.
- In [[sessions/session-052|Session 52]], he is caught in the Bloated One's necrotic explosion and becomes one of the two party members worst affected by the rotting disease. The infection drains Constitution and would turn him into a zombie if it reduced his Constitution to zero; eleven zombies arrive while the party searches the remains.
- In [[sessions/session-053|Session 53]], he helps finish the eleven zombie labourers after Ulrich and Arden destroy many of them with turning magic. Ulrich cures him of the rotting disease after the party rests at the Mercy, and Micaelis later collects a springy spear in Barrow Spa that may let him vault obstacles.
- In [[sessions/session-054|Session 54]], he travels with Arden, Bran, Fred, and Paul toward the Mercy when twelve exceptionally fast, four-armed insectoids attack. After the creatures cut down Fred and Paul, Bran sacrifices himself, allowing Micaelis and Arden to escape with their bodies; Bran's own body cannot be recovered.
- In [[sessions/session-056|Session 56]], he leaps onto a gryphon to attack it at close quarters and is caught in Fred's Web alongside four of the creatures. The ambush leaves six gryphons dead, two captured, and one escaped.
- In [[sessions/session-057|Session 57]], the party detonates two gnomish power cores to trigger a landslide across a mountain route used by goblin raiders. The blast attracts thirteen starving dogs, and the pack bites Micaelis before [[characters/active-players/ben-l/characters/arden-sable|Arden]] persuades it to follow the party.
...
- Introduced directly into the later Westmarsh expedition group.
